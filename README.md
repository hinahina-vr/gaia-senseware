...
| 04 | **すべては次の資源** | UN SDG 12.5.1 | 31の国・地域を切り替え、再資源化率の公式値と補完値を比べる |
...
エネルギー条件、国別人口などを重ねます。USGS震源は06の`SNAPSHOT`だけで表示します。
...
- 作品の入口では、空気・海・森・ごみ・都市・地震・暮らし・エネルギー・人口、という9つの入口から気になるものを一つ選ぶ
