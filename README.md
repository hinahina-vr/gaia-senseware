...
| PC | スマートフォン |
|---|---|
| ![PC版のサウンド選択とキービジュアル](docs/screenshots/contest-entry-pc.png) | ![スマートフォン版の60秒ガイド](docs/screenshots/contest-tour-mobile.png) |
...
左下（スマートフォンでは画面下部）の`INSTALLATION BANK / 01—09`で、同じ惑星へ重ねる感覚器を切り替えます。
...
03〜09は一律の架空年表にせず、各データに合った約48秒のシーケンスです。03は31降水地点、
04は62生物観察記録、05は17地域の公式値＋14地域の補完値、06は31か国、07は世界の142件から年代別に選んだ24件、
08は三層と全層、09は31地域を順に表示します。スライダー操作後は8秒停止し、POIの説明を
...
`STORY`を開くと、9つの感覚器を背景にしたオリジナルのインタラクティブ・システム
...
- 作品の入口では、空気・海・森・生きもの・ごみ・都市・地震・暮らし・エネルギー、という9つの入口から気になるものを一つ選ぶ
