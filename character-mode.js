(() => {
  ...
  const pages = Object.freeze([
    {
      ...
      src: "./artifacts/gx-setting-bible/01-three-ecologies-character-master.png",
    ...
    },
    {
      ...
      src: "./artifacts/gx-setting-bible/02-first-meeting-zushi-coast.png",
    ...
    },
    {
      ...
      src: "./artifacts/gx-setting-bible/03-gaia-senseware-installation.png",
    ...
    },
    {
      ...
      src: "./artifacts/gx-setting-bible/04-life-earth-coevolution.png",
    ...
    },
    {
      ...
      src: "./artifacts/gx-setting-bible/05-anthropocene-planetary-force.png",
    ...
    },
    {
      ...
      src: "./artifacts/gx-setting-bible/06-ai-earth-coevolution.png",
    ...
    },
    {
      ...
      src: "./artifacts/gx-setting-bible/07-three-ecologies-world.png",
    ...
    },
    {
      ...
      src: "./artifacts/gx-setting-bible/08-old-os-to-gx.png",
    ...
    },
    {
      ...
      src: "./artifacts/gx-setting-bible/09-next-stage-civilization.png",
    ...
    },
    {
      ...
      src: "./artifacts/gx-setting-bible/10-final-keyvisual.png",
  ...
  const finishImageLoad = (token) => {
    if (token !== imageLoadToken) return;
    pageButton?.classList.remove("is-loading");
  };
  ...
  const showPage = (requestedPage, direction = 0) => {
    ...
    if (image instanceof HTMLImageElement) {
      ...
      pageButton?.classList.add("is-loading");
      image.alt = page.alt;
      image.addEventListener("load", () => finishImageLoad(token), { once: true });
      image.addEventListener("error", () => finishImageLoad(token), { once: true });
      image.src = page.src;
      if (image.complete && image.naturalWidth > 0) finishImageLoad(token);
    }
