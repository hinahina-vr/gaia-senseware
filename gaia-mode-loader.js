  ...
  const groups = Object.freeze({
    exploration: {
      ...
      styles: [
        ...
        "./map-ui-grid-polish.css?v=gaia-renewable-generation-share-1",
        "./estat-exhibits.css?v=gaia-unified-picker-1",
        ...
        "./statistics-workspace.css?v=gaia-data-insights-1",
        ...
        "./map-exhibit-actions.css?v=gaia-prefecture-city-1",
        "./map-exhibit-categories.css?v=gaia-unified-picker-1",
        ...
        "./live-observation-ui.css?v=gaia-live-observation-ui-1",
        "./story-map-layout.css?v=gaia-story-map-dock-1",
      ],
      scripts: [
        "./mode-entry-guide.js?v=gaia-live-deck-3",
        "./scene-transition.js?v=gaia-66",
        "./data-ledger.js?v=gaia-source-link-icons-1",
        "./data-journey.js?v=gaia-01",
        "./app-content.js?v=gaia-renewable-descending-1",
        "./ecologies-exhibit.js?v=gaia-ecologies-reading-1",
        "./map-exhibit-categories.js?v=gaia-exhibit-order-1",
        "./app.js?v=gaia-story-map-dock-1",
        "./map-ui-grid-polish.js?v=gaia-story-map-dock-1",
        "./map-legend-drag.js?v=gaia-movable-legends-1",
        "./particles-v9.js?v=gaia-light-surface-fps-1",
      ],
      modules: [
        "./src/exploration/index.js?v=gaia-unified-picker-1",
        "./statistics-lab.js?v=gaia-data-insights-1",
      ],
    },
    story: {
      ...
      styles: [
        sharedStylesheet,
        "./scene-transition.css?v=gaia-52",
        "./novel-mode.css?v=gaia-ending-whiteout-1",
        "./true-end.css?v=gaia-ending-whiteout-1",
        "./mode-exit.css?v=gaia-story-control-center-2",
      ],
      scripts: [
        "./scene-transition.js?v=gaia-66",
        ...
        "./ending-glitch.js?v=gaia-horizontal-glitch-1",
        "./novel-mode.js?v=gaia-horizontal-glitch-1",
      ],
