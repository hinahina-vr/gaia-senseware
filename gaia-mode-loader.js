  ...
  const groups = Object.freeze({
    exploration: {
      ...
      styles: [
        ...
        "./map-ui-grid-polish.css?v=gaia-renewable-world-readout-1",
        ...
        "./statistics-workspace.css?v=gaia-ai-dialog-context-1",
        ...
        "./map-observation-typography.css?v=gaia-observation-mincho-1",
        "./map-mobile-shell.css?v=gaia-mobile-shell-1",
      ],
      scripts: [
        ...
        "./app-content.js?v=gaia-renewable-world-readout-1",
        "./ecologies-exhibit.js?v=gaia-ecologies-reading-1",
        "./map-exhibit-categories.js?v=gaia-exhibit-order-1",
        "./app.js?v=gaia-mobile-shell-1",
        "./map-ui-grid-polish.js?v=gaia-story-map-dock-1",
        "./map-legend-drag.js?v=gaia-observation-mincho-1",
        "./map-mobile-shell.js?v=gaia-mobile-shell-1",
        "./particles-v9.js?v=gaia-light-surface-fps-1",
      ],
      modules: [
        "./src/exploration/index.js?v=gaia-observation-mincho-1",
        "./statistics-lab.js?v=gaia-renewable-world-readout-1",
      ],
    },
    story: {
