  ...
  const groups = Object.freeze({
    exploration: {
      ...
      styles: [
        ...
        "./map-ui-grid-polish.css?v=gaia-live-map-question-1",
        "./estat-exhibits.css?v=gaia-estat-comparison-nowrap-1",
        ...
        "./statistics-workspace.css?v=gaia-observation-dialogue-1",
        "./mode-exit.css?v=gaia-story-control-center-2",
        "./map-instrument-ui.css?v=gaia-poi-compact-card-1",
        "./map-chapter-navigation.css?v=gaia-live-map-question-1",
        "./map-exhibit-actions.css?v=gaia-estat-comparison-nowrap-1",
        ...
        "./map-demo.css?v=gaia-map-demo-1",
      ],
      scripts: [
    ...
    story: {
      ...
      styles: [
        sharedStylesheet,
        "./scene-transition.css?v=gaia-52",
        "./novel-mode.css?v=gaia-true-end-glitch-1",
      ...
      scripts: [
        ...
        "./true-end-mode.js?v=gaia-true-end-separator-1",
        ...
        "./novel-mode.js?v=gaia-true-end-glitch-1",
      ],
