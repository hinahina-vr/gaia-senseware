(() => {
  ...
  const gallery = Object.freeze([
    {
      ...
      assetPath: "assets/visuals-07/event-cg-first-encounter-five-plane-v2.png",
    ...
    },
    {
      ...
      assetPath: "assets/visuals-07/event-cg-amane-closeup-five-plane-v2.png",
    ...
    },
    {
      ...
      assetPath: "assets/visuals-07/event-cg-mizuha-closeup-five-plane-v2.png",
  ...
  const limitedStory = Object.freeze([
    ...
    { id: "festival-gaia-booth-approach", sceneId: "festival_concept", from: 13, to: 14, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "drift-left" },
    { id: "festival-first-encounter-cg", sceneId: "festival_concept", from: 15, to: 20, assetPath: "assets/visuals-07/event-cg-first-encounter-five-plane-v2.png", motion: "event-focus", presentation: "event-cg", galleryId: "first-encounter" },
    { id: "festival-amane-closeup-cg", sceneId: "festival_concept", from: 21, to: 22, assetPath: "assets/visuals-07/event-cg-amane-closeup-five-plane-v2.png", motion: "event-focus", presentation: "event-cg", galleryId: "amane-closeup" },
    { id: "festival-mizuha-closeup-cg", sceneId: "festival_concept", from: 23, to: 26, assetPath: "assets/visuals-07/event-cg-mizuha-closeup-five-plane-v2.png", motion: "event-focus", presentation: "event-cg", galleryId: "mizuha-closeup" },
    { id: "festival-gaia-booth-conversation", sceneId: "festival_concept", from: 27, to: 75, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "drift-left" },
    { id: "festival-map-transition", sceneId: "festival_concept", from: 76, to: 76, assetPath: "assets/visuals-07/event-cg-festival-map-transition-five-plane-v2.png", motion: "event-focus", presentation: "event-cg" },
    ...
    { id: "gx-human-choice", sceneId: "gx_experience", from: 45, to: 54, assetPath: "assets/visuals-07/novel-bg-gx-temperature-anomaly-five-plane-v1.png", motion: "drift-right" },
    { id: "gx-ten-mode-gateway", sceneId: "gx_experience", from: 55, to: 58, assetPath: "assets/visuals-07/novel-bg-gx-mode-gateway-five-plane-v2.png", motion: "push-in" },
    { id: "esp32-exhibition-opening", sceneId: "esp32_pitch", from: 1, to: 7, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "drift-left" },
    { id: "esp32-exhibition-proposal", sceneId: "esp32_pitch", from: 8, to: 18, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "drift-right", galleryId: "esp32-collaboration" },
    ...
    { id: "esp32-co-created-prototype", sceneId: "esp32_pitch", from: 27, to: 38, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "drift-right" },
    { id: "esp32-exhibition-return", sceneId: "esp32_pitch", from: 39, to: 43, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "push-in" },
    { id: "circle-closing-exhibition", sceneId: "circle_invitation", from: 1, to: 10, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "push-in" },
    ...
    { id: "circle-invitation-card-cg", sceneId: "circle_invitation", from: 29, to: 47, assetPath: "assets/visuals-07/event-cg-circle-invitation-card-v2.png", motion: "event-focus", presentation: "event-cg" },
    ...
    { id: "welcome-online-arrival", sceneId: "welcome_chat", from: 1, to: 20, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "drift-left" },
    { id: "welcome-online-esp32-thread", sceneId: "welcome_chat", from: 21, to: 40, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "drift-right" },
    { id: "welcome-co-created-future", sceneId: "welcome_chat", from: 41, to: 54, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "push-in" },
    { id: "welcome-physical-booth", sceneId: "welcome_chat", from: 55, to: 68, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "drift-left" },
    { id: "welcome-booth-packdown", sceneId: "welcome_chat", from: 69, to: 73, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "drift-right" },
    ...
    { id: "welcome-earth-partner-reflection", sceneId: "welcome_chat", from: 84, to: 91, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-v1.png", motion: "push-in" },
