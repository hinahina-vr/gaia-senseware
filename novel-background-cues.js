(() => {
  ...
  const limitedStory = Object.freeze([
    ...
    { id: "gx-present-return", sceneId: "gx_experience", from: 42, to: 44, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-autumn-morning-v2.png", motion: "push-in" },
