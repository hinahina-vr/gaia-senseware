(() => {
  ...
  const limitedStory = Object.freeze([
    { id: "festival-convention-hall-entrance", sceneId: "festival_concept", from: 1, to: 7, assetPath: "assets/visuals-07/novel-bg-convention-hall-entrance-autumn-morning-v1.png", motion: "push-in" },
