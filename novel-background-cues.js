(() => {
  ...
  const limitedStory = Object.freeze([
    ...
    { id: "map01-data-provenance", sceneId: "map_mode01", from: 29, to: 40, assetPath: "assets/visuals-07/novel-bg-map01-data-provenance-autumn-morning-v2.png", motion: "drift-left" },
    ...
    { id: "gx-ocean-entry", sceneId: "gx_experience", from: 1, to: 16, assetPath: "assets/visuals-07/novel-bg-gx-ancient-ocean-autumn-morning-v2.png", motion: "push-in" },
    { id: "gx-native-deep-time", sceneId: "gx_experience", from: 17, to: 17, assetPath: "assets/visuals-07/novel-bg-exhibition-autumn-morning-close-v4.png", motion: "drift-right" },
    ...
    { id: "gx-coevolution", sceneId: "gx_experience", from: 30, to: 41, assetPath: "assets/visuals-07/novel-bg-gx-breathing-points-autumn-morning-v2.png", motion: "drift-left" },
    ...
    { id: "gx-human-choice", sceneId: "gx_experience", from: 45, to: 54, assetPath: "assets/visuals-07/novel-bg-gx-temperature-anomaly-autumn-morning-v2.png", motion: "drift-right" },
    { id: "gx-ten-mode-gateway", sceneId: "gx_experience", from: 55, to: 58, assetPath: "assets/visuals-07/novel-bg-gx-mode-gateway-autumn-morning-v3.png", motion: "push-in" },
    ...
    { id: "esp32-exhibition-proposal", sceneId: "esp32_pitch", from: 8, to: 18, assetPath: "assets/visuals-07/novel-bg-festival-five-plane-projection-autumn-morning-v2.png", motion: "drift-right", galleryId: "esp32-collaboration" },
    ...
    { id: "circle-private-invitation", sceneId: "circle_invitation", from: 11, to: 28, assetPath: "assets/visuals-07/novel-bg-exhibition-autumn-morning-wide-v4.png", motion: "drift-left" },
    ...
    { id: "circle-after-welcome", sceneId: "circle_invitation", from: 70, to: 81, assetPath: "assets/visuals-07/novel-bg-exhibition-autumn-morning-close-v4.png", motion: "drift-right" },
