(() => {
  ...
  const limitedStory = Object.freeze([
    { id: "festival-campus-entrance", sceneId: "festival_concept", from: 1, to: 1, assetPath: "assets/visuals-07/zushi-campus-story-bg-v4.webp", motion: "drift-right" },
    { id: "festival-venue-reception", sceneId: "festival_concept", from: 2, to: 7, assetPath: "assets/visuals-07/novel-bg-coastal-venue-v3.png", motion: "push-in" },
    { id: "festival-gaia-booth-approach", sceneId: "festival_concept", from: 8, to: 14, assetPath: "assets/visuals-07/novel-bg-exhibition-v3.png", motion: "drift-left" },
    ...
    { id: "festival-gaia-booth-conversation", sceneId: "festival_concept", from: 27, to: 46, assetPath: "assets/visuals-07/novel-bg-exhibition-v2.png", motion: "drift-left" },
