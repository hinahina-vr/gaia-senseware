...
|---|---|---|---|
| festival_build | 001–015 | 001–008 | 現在の展示席、二人の姿、三人の作者名 |
...
| mode03_map | 030–033 | 018–020 | 現在の展示席と時刻確認への接続 |
...
| scene / step | 時刻 | 場所 | 内容 |
|---|---|---|---|
| final_record_008 | 15:52 | 展示席 | 前夜の面談希望と当日の本人同意に基づく大学の公式連絡 |
| final_record_017 | 15:54 | 展示席 | saku既存アカウントからの現在音声 |
| return_to_start_001 | 15:55 | 展示席 | 展示を一時休止する |
...
- `festival_build_001`〜`final_record_027`は展示席／展示端末を基準にする。ただしMODE07からinterludeは承認済みの公開前夜RECORD背景を使う。
- `final_record_008`〜`027`は展示席。15:54は運営用スマートフォンの音声着信だが、学内チャット投稿UIではない。
- `return_to_start_001`〜`017`は展示席。主人公の行動と観察はここで終了する。
