...
初回画面の「60秒で作品を見る」、または上記の `#tour` URLを使うと、作品コンセプト、世界地図、宇宙観測、ESP32、観測ノートを順に確認できます。ガイドは一時停止、前後移動、終了が可能です。
...
| モバイル | Chromeの縦画面・短い横画面でサウンド画面とガイドを操作 |
