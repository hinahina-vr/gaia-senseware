...
上記の `#tour` URLから「60秒で地球を感じる」ガイドを開くと、実際の地球観測地図、年代スライダー、データ変換パネル、宇宙観測を操作しながら作品全体を確認できます。ガイドは60秒で自動進行し、一時停止、前後移動、終了も可能です。通常URLでは、作品のキービジュアルとサウンド選択から映画的オープニングへ入ります。
