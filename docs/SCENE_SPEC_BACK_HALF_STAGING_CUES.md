...
|---|---|---|---|
| `festival_build_001`〜`_018` | CURRENT 2026-11-01 14:40 | 展示席 / `novel-bg-exhibition-v3.png` | scene内固定 |
| `gx_deep_time_001`〜`_026` | CURRENT 14:44 | 展示席 / exhibition-v3 | MODEは背景上のモーダル。`_002`開始、`_003`復帰 |
| `mode03_map_001`〜`_020` | CURRENT 14:53 | 展示席 / exhibition-v3 | `_002`開始、`_003`復帰 |
| `mode07_abstract_001`〜`_008` | CURRENT 15:00 | 展示席 / exhibition-v3 | `_008→_009`でCURRENT→RECORD、一度だけfade |
...
| `mode08_map_layers_001`〜`_019` | CURRENT 15:22 | 展示席 / exhibition-v3 | scene入口でRECORD→CURRENT。`_002`開始、`_003`復帰 |
| `mode10_space_001`〜`_018` | CURRENT 15:30 | 展示席 / exhibition-v3 | `_002`開始、`_003`復帰。`_009`〜`_014`は横長展示端末 |
| `choice_editorial_001`〜`_007` | CURRENT 15:38 | 展示席 / exhibition-v3 | 固定 |
| `epilogue_reflection_field_001`〜`_002` | CURRENT 15:42 | 展示席 / exhibition-v3 | 固定 |
| `choice_reflection_001`〜`_003` | CURRENT 15:44 | 展示席 / exhibition-v3 | R01→R36固定 |
| `final_record_001`〜`_007` | CURRENT 15:47 | 展示席 / exhibition-v3 | 固定 |
| `final_record_008`〜`_016` | CURRENT 15:52 | 展示席 / exhibition-v3 | 運営スマホ準備→公式通知 |
| `final_record_017`〜`_027` | CURRENT 15:54 | 展示席 / exhibition-v3 | 同じ運営スマホの音声着信。二重フレーム・再入場animation禁止 |
| `return_to_start_001`〜`_017` | CURRENT 15:55 | 展示席 / exhibition-v3 | 休止札と展示席の実見。ここまで主人公視点 |
...
- `final_record_009`〜`_027`のサクヤは通知／通話先。大型立ち絵を出さず、物理的に展示席へ配置しない。
