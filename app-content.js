...
`.trim(),
  ...
  const modeConcepts = {
    ...
    "earth-organ": {
      ...
      context:
        "再生可能エネルギー発電割合は、日射や風だけでなく、水力資源、政策、送電網、設備、費用、電力需要などにも左右されます。黄色と緑は導入可能量や因果関係を計算した値ではありません。",
  ...
  const modeDataNarratives = Object.freeze({
    ...
    "earth-organ": "地図の見方：31か国の国土を、電力に占める再生可能エネルギーの割合で塗ります。暗い青は0%に近く、明るい水色は100%に近い比率です。自動再生とスライダーは高い国から低い国へ移動します。黄色の日射円と緑の風矢印は選択国の補足で、現在の比率を説明する因果モデルではありません。",
