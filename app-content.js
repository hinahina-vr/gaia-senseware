...
`.trim(),
    },
    {
      ...
      titleJa: "地球からのメッセージ",
      description: "USGSの世界M7.5以上を2000〜2026年まで自動で送り、各年の震源を発生日時順に一つずつ表示します。年度の終わりは逆順に一つずつ消え、次年度が発生日時順に立ち上がります。点に続いて輪が広がり、Magnitudeから見積もった可感半径の目安で止まります。輪は実際の震度分布・被害範囲・津波範囲ではありません。気象庁の日本実測震度は別層です。",
      accent: "#ffb45f",
      rgb: "255, 180, 95",
      source: `
...
`.trim(),
  ...
  const modeConcepts = {
    ...
    "rhythm-of-disaster": {
      ...
      touch:
        "年度は自動で進み、切替時には旧年の震源を発生日時の逆順に一つずつ消してから、新年の最初の地震から順番に再生します。スライダーで任意の年へ移動でき、震源を押すと発生日・深さ・Magnitudeを読めます。日本の震度6弱以上の実測記録は、左下の切替から別層で見られます。",
      context:
