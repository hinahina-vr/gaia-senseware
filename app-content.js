...
(() => {
  ...
  const MAP_MODE_DESCRIPTIONS = Object.freeze({
    ...
    "earth-organ": "電気のうち、どれだけを再生可能エネルギーでまかなっているのか。公開データのある世界の国・地域を比べる地図です。",
    ...
    "estat-summer-high": "一日の最高気温は、どれくらい変わってきたのか。毎日の最高気温を一年で平均した値です。夏だけの平均や、その年の最高記録ではありません。",
    "estat-winter-low": "一日の最低気温は、どれくらい変わってきたのか。毎日の最低気温を一年で平均した値です。冬だけの平均や、その年の最低記録ではありません。",
  ...
  // One-line chapter subtitles, keyed by the current public exhibition number.
  // Keep source qualifications and longer explanations in MAP_MODE_DESCRIPTIONS.
  const MAP_TITLE_SUBTITLES = Object.freeze({
    "01": "衛星が捉えた、火災と高温の記録",
    "02": "世界の風向と速さ、気圧を読み解く",
    "03": "微粒子と光の通りにくさを、霞で描く",
    "04": "直近24時間の地震を、時刻と規模でたどる",
    "05": "雲量と日射から、地上に届く光を描く",
    "06": "CO₂の記録から、地球の呼吸をたどる",
    "07": "同じ流れが続くとしたら、海はどこへ運ぶのか",
    "08": "森の分布と雨の量を、ひとつの地図で見比べる",
    "09": "捨てたものが、もう一度資源になるまで",
    "10": "化石燃料の排出記録に、夜の街の光を重ねる",
    "11": "世界の大地震、その時と場所をたどる",
    "12": "森と都市、そして文化のつながりを読み解く",
    "13": "再生可能エネルギーが支える、国ごとの電力",
    "14": "1960年から続く、世界の人口の移り変わり",
    "15": "47の街の風速を、光の線で描く",
    "16": "CO₂濃度の予測を、広がる光の輪に",
    "17": "街ごとの降水量を、雨粒と波紋に映す",
    "18": "街の気温がつくる、光の色と揺らぎ",
    "19": "空を覆う雲の量を、重なり合う光に映す",
    "20": "PM2.5の予測を、淡い霞の濃さに映す",
    "21": "入ってくる人、出ていく人、その差を追う",
    "22": "旅先に泊まる人の数を、土地の灯りに",
    "23": "新しい住まいが、どこで建ち始めているのか",
    "24": "1955年からの年平均気温、その変化を追う",
    "25": "毎日の最高気温を、一年で平均して比べる",
    "26": "毎日の最低気温を、一年で平均して比べる",
    "27": "年平均の相対湿度で、土地の湿りを見比べる",
    "28": "一年に積み重なる、日差しの時間をたどる",
    "29": "一年に降る雨と雪を、水の量で見比べる",
    "30": "雨の量ではなく、雨が降った日数をたどる",
  });
...
`.trim(),
  ...
  const modeConcepts = {
    ...
    "earth-organ": {
      lead:
        "総発電量に占める再生可能エネルギーの割合は、国ごとにどれくらい違うでしょう。国土そのものを塗り、世界の差を一目で比べます。",
      seeing:
