...
`.trim(),
    },
    {
      ...
      titleJa: "捨てた先の未来",
      description: "国連SDG 12.5.1の都市ごみ再資源化率を、公表値のある国・地域の同じ大きさの円グラフで比較します。緑は再資源化、橙はそれ以外。国連の公表値を用い、未収録を近隣国の推定値では埋めません。総量や処理先は示さず、報告年にも違いがあります。",
      accent: "#b4ef6d",
      rgb: "180, 239, 109",
      source: `
...
`.trim(),
  ...
  const modeConcepts = {
    ...
    "nothing-is-waste": {
      ...
      seeing:
        "各円の緑が再資源化率、橙が再資源化として報告されなかった残りです。円の直径はすべて同じなので、緑の扇形が大きい国ほど再資源化率が高いと読めます。国連の公表値を使います。未収録はゼロや近隣国の推定値で埋めません。",
      touch:
        "左右ボタンかスライダーで公表値のある国・地域を一つずつ切り替えられます。国の円グラフを押して直接選ぶこともでき、再資源化率、報告年、国連の公表値と出典を確認できます。",
      context:
        "授業「自然界にはゴミもうんちも存在しない」では、ある生きものの不要物が次の生きものの材料になる循環を扱います。人の製品も、作るときから回収や修理まで考える必要があります。",
      question: "緑より橙が大きい国はどこでしょう。報告年や定義の違い、未収録に注意して、国ごとの差を比べてみましょう。",
    },
    "anthropocene-scar": {
      lead:
  ...
  const modeDataNarratives = Object.freeze({
    ...
    "nothing-is-waste": "地図の見方：同じ大きさの円グラフの緑が再資源化率、橙がそれ以外です。国連の公表値のみを表示し、未収録はゼロや近隣国の推定値で埋めません。左右ボタンとスライダーで公表値のある国・地域を切り替え、報告年とデータ区分を確認できます。",
