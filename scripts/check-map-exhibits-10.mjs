...
assert.match(html, /gaia-mode-loader\.js\?v=gaia-light-surface-fps-1/u);
...
assert.match(modeLoaderSource, /app\.js\?v=gaia-light-surface-fps-1/u);
...
assert.match(modeLoaderSource, /styles\.css\?v=gaia-scroll-cue-1/u);
