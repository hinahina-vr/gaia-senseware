...
assert.match(appSource, /currentBrushLanguage = "one-data-anchored-brush-per-visible-poi"/u);
...
assert.match(appContentSource, /float forwardReach = mix\(0\.13, 0\.34, measuredSpeed\)/u);
...
assert.match(html, /gaia-mode-loader\.js\?v=gaia-map-guide-left-to-right-1/u);
...
assert.match(modeLoaderSource, /src\/exploration\/index\.js\?v=gaia-shared-map-zoom-1/u);
