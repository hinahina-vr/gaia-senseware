...
assert.match(html, /gaia-mode-loader\.js\?v=gaia-guide-exclusion-1/u);
...
assert.match(modeLoaderSource, /app\.js\?v=gaia-guide-exclusion-1/u);
...
assert.match(appContentSource, /blendedDirection[\s\S]*interpolationWeight[\s\S]*continuousCoverage[\s\S]*continuousSea/u);
