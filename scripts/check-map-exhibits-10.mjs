...
assert.match(html, /gaia-mode-loader\.js\?v=gaia-sound-reactive-ribbons-1/u);
...
assert.match(modeLoaderSource, /app\.js\?v=gaia-gentle-entry-guide-1/u);
assert.match(modeLoaderSource, /styles\.css\?v=gaia-gentle-entry-guide-2/u);
