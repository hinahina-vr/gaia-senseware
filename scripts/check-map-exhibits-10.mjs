...
assert.match(modeLoaderSource, /map-ui-grid-polish\.css\?v=gaia-live-map-question-1/u);
...
assert.match(modeLoaderSource, /map-chapter-navigation\.css\?v=gaia-live-map-question-1/u);
