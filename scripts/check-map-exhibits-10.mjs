...
assert.match(modeLoaderSource, /app-content\.js\?v=gaia-human-history-2/u);
assert.match(modeLoaderSource, /app\.js\?v=gaia-human-history-2/u);
assert.match(modeLoaderSource, /styles\.css\?v=gaia-live-map-base-2/u);
