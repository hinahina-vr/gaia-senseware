...
assert.match(html, /gaia-mode-loader\.js\?v=gaia-integrated-light-bank-1/u);
assert.match(modeLoaderSource, /map-ui-grid-polish\.css\?v=gaia-live-compact-jpt-audio-1/u);
assert.match(modeLoaderSource, /map-ui-grid-polish\.js\?v=gaia-map-overlay-alignment-1/u);
assert.match(modeLoaderSource, /app-content\.js\?v=gaia-abstract-entry-1/u);
assert.match(modeLoaderSource, /app\.js\?v=gaia-integrated-light-bank-1/u);
assert.match(modeLoaderSource, /src\/exploration\/index\.js\?v=gaia-live-compact-jpt-audio-1/u);
...
assert.match(modeLoaderSource, /styles\.css\?v=gaia-integrated-light-bank-1/u);
