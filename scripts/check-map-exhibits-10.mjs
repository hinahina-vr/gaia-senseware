...
assert.match(html, /gaia-mode-loader\.js\?v=gaia-estat-picker-1/u);
...
assert.match(modeLoaderSource, /app\.js\?v=gaia-estat-picker-1/u);
...
assert.match(modeLoaderSource, /src\/exploration\/index\.js\?v=gaia-estat-picker-1/u);
assert.match(modeLoaderSource, /firms-exhibit\.css\?v=gaia-firms-no-return-1/u);
assert.match(modeLoaderSource, /planet-signals-exhibit\.css\?v=gaia-poi-soft-light-1/u);
