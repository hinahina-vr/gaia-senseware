...
assert.match(liveExhibitsSource, /data-live-sound-toggle[\s\S]*data-live-sound-label>音をひらく/u);
...
assert.match(modeLoaderSource, /src\/exploration\/index\.js\?v=gaia-title-only-1/u);
...
assert.match(modeLoaderSource, /styles\.css\?v=gaia-no-breathing-flash-1/u);
