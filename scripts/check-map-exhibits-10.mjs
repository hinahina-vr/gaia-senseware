...
assert.match(html, /gaia-mode-loader\.js\?v=gaia-character-file-1/u);
...
assert.match(modeLoaderSource, /app\.js\?v=gaia-character-file-1/u);
...
assert.match(modeLoaderSource, /styles\.css\?v=gaia-character-file-1/u);
