...
assert.match(html, /gaia-mode-loader\.js\?v=gaia-tour-clear-1/u);
...
assert.match(modeLoaderSource, /app\.js\?v=gaia-story-map-aiva-1-live-base-1/u);
...
assert.match(modeLoaderSource, /styles\.css\?v=gaia-title-only-1/u);
