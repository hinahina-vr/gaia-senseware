...
try {
  ...
  const chat = steps.find((step) => step.id === "opening_empty_seat_005");
  ...
  const objectiveOpeningSteps = steps.filter((step) => step.sceneId === "opening_empty_seat");
  for (const objectiveStep of objectiveOpeningSteps) {
