...
const checks = [
  ...
  ["command dock assets use the current cache key", ["map-ui-grid-polish.css?v=gaia-live-mobile-controls-1", "map-ui-grid-polish.js?v=gaia-no-bank-chevron-1"].every((asset) => loader.includes(asset))],
