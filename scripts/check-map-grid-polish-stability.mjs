...
const checks = [
  ...
  ["command dock assets use the current cache key", ["map-ui-grid-polish.css?v=gaia-focus-guide-1", "map-ui-grid-polish.js?v=gaia-focus-guide-1"].every((asset) => loader.includes(asset))],
