...
const checks = [
  ...
  ["command dock assets use the current cache key", ["map-ui-grid-polish.css?v=gaia-live-metric-fit-1", "map-ui-grid-polish.js?v=gaia-live-deck-3"].every((asset) => loader.includes(asset))],
