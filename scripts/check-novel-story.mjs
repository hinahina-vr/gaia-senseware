...
const expectedHash = "b59f43f536d727d73fcf95d19298f1750f66092a6dbcbd207fedad9b3cb1aa8d";
...
assert.equal(canonBytes.length, 53597, "freeze正本のbytesが変わりました");
