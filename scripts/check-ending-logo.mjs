...
assert(read("gaia-mode-loader.js").includes("novel-mode.css?v=gaia-ending-whiteout-1"));
assert(read("gaia-mode-loader.js").includes("novel-mode.js?v=gaia-horizontal-glitch-1"));
assert(read("index.html").includes("gaia-mode-loader.js?v=gaia-story-map-dock-1"));
