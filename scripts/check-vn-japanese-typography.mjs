...
const scans = [
  ...
  ["mobile UI cache keys", ["styles.css?v=gaia-cross-platform-fonts-1", "novel-mode.css?v=gaia-dialogue-wrap-1", "novel-mode.js?v=gaia-dialogue-wrap-1", "mode-exit.css?v=gaia-mobile-ui-audit-1"].every((asset) => html.includes(asset))],
];
